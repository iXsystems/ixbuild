...
# Author: Joe Maloney
# License: BSD
# Location for tests into REST API of FreeNAS 10
...
. ${PROGDIR}/../utils/resty -W "http://${ip}:80/api/v2.0" -H "Accept: application/json" -H "Content-Type: application/json" -u ${fuser}:${fpass}
